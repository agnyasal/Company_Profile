    ...
    <div className="bg-white py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <p className="text-center mb-4">
          Got burning questions, seeking a travel confidante, or just in the
          mood for a friendly chat? <br /> Our dynamic team is at your beck and
          call! <br /> Dive into a world of personalized support, grab travel
          tips, or fire away with any curiosities you might have.
        </p>
